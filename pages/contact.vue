                    ...
                    <div class="lg:col-span-1 space-y-6">
                        ...
                        <div v-motion :initial="{ opacity: 0, x: 50 }"
                            ...
                            <div class="flex gap-3">
                                <a href="https://facebook.com/modeli" target="_blank" rel="noopener noreferrer"
                                ...
                                <a href="https://twitter.com/modeli" target="_blank" rel="noopener noreferrer"
                                    class="w-12 h-12 bg-accent/10 hover:bg-accent rounded-full flex items-center justify-center transition-all duration-300 group"
                                    aria-label="Twitter">
                                    <svg class="w-6 h-6 text-accent group-hover:text-primary transition-colors"
                                        fill="currentColor" viewBox="0 0 24 24">
                                ...
                                <a href="https://linkedin.com/company/modeli" target="_blank" rel="noopener noreferrer"
                                    class="w-12 h-12 bg-accent/10 hover:bg-accent rounded-full flex items-center justify-center transition-all duration-300 group"
                                    aria-label="LinkedIn">
                                    <svg class="w-6 h-6 text-accent group-hover:text-primary transition-colors"
                                        fill="currentColor" viewBox="0 0 24 24">
                                ...
                                <a href="https://instagram.com/modeli" target="_blank" rel="noopener noreferrer"
                                    class="w-12 h-12 bg-accent/10 hover:bg-accent rounded-full flex items-center justify-center transition-all duration-300 group"
