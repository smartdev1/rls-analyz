      ...
      >
        ...
        <div>
          <div class="flex items-center space-x-2 mb-4">
            ...
            <span class="text-2xl font-heading font-bold">RLS ANALYZ</span>
          </div>
          <p class="text-white/70 text-sm leading-relaxed mb-4">
            Votre partenaire immobilier d'entreprise. Découvrez des biens d'exception et bénéficiez de nos services de conseil pour votre entreprise.
          </p>
          <!-- Coordonnées -->
          <div class="space-y-2 text-sm text-white/70">
            <p class="flex items-start">
              <svg
                xmlns="http://www.w3.org/2000/svg"
                class="h-5 w-5 mr-2 flex-shrink-0 text-accent"
                fill="none"
                viewBox="0 0 24 24"
                stroke="currentColor"
              >
        ...
        <div>
          <h3 class="font-heading text-lg font-semibold mb-4">Navigation</h3>
        ...
        <!-- Colonne 3 : Légal -->
        <div>
          <h3 class="font-heading text-lg font-semibold mb-4">Légal</h3>
          <ul class="space-y-3 text-sm">
            <li>
              <NuxtLink
                to="/mentions-legales"
            ...
            <li>
              <NuxtLink
                ...
                class="text-white/70 hover:text-accent transition-colors inline-flex items-center group"
              >
                <span class="group-hover:translate-x-1 transition-transform">Politique de confidentialité</span>
              </NuxtLink>
            </li>
            <li>
              <NuxtLink
                ...
                class="text-white/70 hover:text-accent transition-colors inline-flex items-center group"
              >
                <span class="group-hover:translate-x-1 transition-transform">Conditions d'utilisation</span>
              </NuxtLink>
            </li>
            <li>
              <NuxtLink
                ...
                class="text-white/70 hover:text-accent transition-colors inline-flex items-center group"
              >
                <span class="group-hover:translate-x-1 transition-transform">Gestion des cookies</span>
              </NuxtLink>
            </li>
          </ul>
        </div>
        ...
        <div>
          <h3 class="font-heading text-lg font-semibold mb-4">Suivez-nous</h3>
          <p class="text-white/70 text-sm mb-4">
            Restez informé de nos dernières actualités et nouveaux biens.
          </p>
          <div class="flex space-x-3">
            ...
            >
              <svg
                xmlns="http://www.w3.org/2000/svg"
                class="h-5 w-5 group-hover:text-primary transition-colors"
                fill="currentColor"
                viewBox="0 0 24 24"
              >
...
import { fadeInUp, fadeIn } from "../../utils/motionPresets"
...
<style scoped>
/* Effet de glissement au survol des liens */
a span {
